...
?>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 min-vh-100">
      ...
      <a href="<?= $main_url ?>rekamedis/tambah-data.php" 
      class="btn btn-outline-secondary btn-sm mb-3 " title="tambah data"><i class="bi bi-plus-lg align-top"></i>Data Perekaman</a>
      ...
      <table class="table table-responsive table-hover" id="myTable">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= $rm['obat']?></td>
                <td>
                    <a href="edit-data.php?id=<?= $rm['no_rm'] ?>
                    " class="btn btn-sm btn-outline-warning" 
                    title="edit data"><i class="bi bi-pen align-top"></i></a>
                    <a href="proses-data.php?id=<?= $rm['no_rm'] ?>
                    &aksi=hapus-data" 
                    onclick="return confirm('Anda yakin akan menghapus data ini ?')" 
                    class="btn btn-sm btn-outline-danger" 
                    title="hapus data"><i class="bi bi-trash align-top"></i></a>
                </td>
            </tr>
            <?php } ?>
        </tbody>
