        ...
        <div class="row">
            <div class="col-lg-6 pe-4">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="date" name="tgl" class="form-control" id="tgl" value="<?= $rm['tgl_rm'] ?>" readonly>
                </div>
                <div class="form-group mb-3">
                    ...
                    <textarea name="" id="alamatPasien" class="form-control " placeholder="alamat pasien" rows="1" readonly><?= $rm['alamatpasien'] ?></textarea>
                </div> 
                <div class="form-group mb-3">
                    <label for="keluhan" class="form-label">Keluhan</label>
                    <textarea name="keluhan" id="keluhan" class="form-control" placeholder="keluhan pasien tentang penyakitnya" ><?= $rm['keluhan'] ?></textarea>
                </div>
            </div>
