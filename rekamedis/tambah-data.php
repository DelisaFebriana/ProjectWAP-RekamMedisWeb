        ...
        <div class="row">
            ...
            <div class="col-lg-6 pe-4">
                ...
                <div class="form-group mb-3">
                    ...
                    <textarea name="" id="alamatPasien" class="form-control border-0 border-bottom " placeholder="alamat pasien" ></textarea>
                </div> 
                <div class="form-group mb-3">
                    <label for="keluhan" class="form-label">Keluhan</label>
                    <textarea name="keluhan" id="keluhan" class="form-control" placeholder="keluhan pasien tentang penyakitnya" ></textarea>
                </div>
            </div>
